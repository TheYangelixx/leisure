...
class Game:
    def __init__(self):
        ...
        # load game icon
        icon = pygame.image.load("Chess\\res\chess_icon.png")
        # set game icon
    ...
    def start_game(self):
        ...
        self.board_img = pygame.image.load("Chess\\res\\board.png").convert()
        ...
        pieces_src = os.path.join("Chess\\res\pieces.png")
    ...
    def menu(self):
        ...
        created_by = small_font.render("Created by Farzanegan allies", True, black_color)
